...
class MultiStageRetriever:
    ...
    def __init__(self, vector_store=None, cross_encoder_model: str = "cross-encoder/ms-marco-MiniLM-L-6-v2"):
    ...
    def _get_temporal_score(self, timestamp: Optional[str], lambda_decay: float = 0.1) -> float:
    ...
    def retrieve(self, 
                 ...
                 limit: int = 5, 
                 temporal_weight: float = 0.2) -> List[Dict[str, Any]]:
        """
        ...
        if self.bm25:
            ...
            for idx in top_n_idx:
                if bm25_scores[idx] > 0:
                    ...
                    if "id" in meta: seen_ids.add(meta["id"])
